...
class Colors:
    ...
    def __init__(self):
        ...
        hexs = ('072AC8', 'FF9D97', 'FF701F', 'FFB21D', 'CFD231', '48F90A', '92CC17', '3DDB86', '1A9334', '00D4BB',
                '2C99A8', '00C2FF', '344593', '6473FF', '0018EC', '8438FF', '520085', 'CB38FF', 'FF95C8', 'FF37C7')
        self.palette = [self.hex2rgb(f'#{c}') for c in hexs]
        self.n = len(self.palette)
        self.pose_palette = np.array([[7, 42, 200], [255, 153, 51], [255, 178, 102], [230, 230, 0], [255, 153, 255],
...
def feature_visualization(x, module_type, stage, n=32, save_dir=Path('runs/detect/exp')):
    ...
    if height > 1 and width > 1:
        ...
        n = 4  # number of plots
        fig, ax = plt.subplots(2, 2, tight_layout=True)  # 8 rows x n/8 cols
        ax = ax.ravel()
        ...
        plt.savefig(f, dpi=900, bbox_inches='tight')
        plt.close()
